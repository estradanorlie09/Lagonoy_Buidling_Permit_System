const requiredDocs = {
    plumbing_plans:
        " Sanitary / Plumbing Plans (signed & sealed by Sanitary Engineer / Plumber)",
    specification: "Specifications (if separate from plans)",
    bill: " Plumbing Bill of Materials & Cost Estimates",
    location:
        "Location / Site Development Plan (showing septic tank, drainage, etc)",
};
