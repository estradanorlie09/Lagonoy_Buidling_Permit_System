...
@section('content')
    <div
        ...
        <div class="w-full max-w-6xl mx-auto bg-white shadow-xl rounded-xl p-6 md:p-8">
            ...
            <div class="text-center mb-6">
                <div class="flex justify-center mb-3">
                    <div
                        class="w-14 h-14 flex items-center justify-center bg-gradient-to-br from-blue-100 to-indigo-100 text-blue-600 rounded-full shadow-md">
                        <i class="fas fa-user-cog text-2xl"></i>
                    </div>
                </div>
                <h1
                    class="text-2xl md:text-3xl font-extrabold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                    Profile Settings</h1>
            ...
            <form action="{{ route('update_user_profile') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select id="role" name="role" disabled
                        class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-gray-600 bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input type="text" name="first_name"
                                ...
                                class="w-full border border-gray-300 rounded-lg p-2.5 mt-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-all">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') ?? auth()->user()->email }}"
                                disabled
                                class="w-full border border-gray-300 bg-gray-50 text-gray-500 rounded-lg p-2.5 mt-1 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                        </div>
                        <div>
                ...
                <button type="submit"
                    class="w-full mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold py-3 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl">
