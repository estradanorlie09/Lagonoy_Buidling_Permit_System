    ...
    @section('content')
        <div x-data="{ open: false }" class="bg-white max-w-10xl mx-auto px-6 py-8">

            <div
                class="relative rounded-2xl overflow-hidden bg-gradient-to-br from-rose-50 via-red-100 to-red-200 shadow-lg mb-6 p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 border border-red-100">
                ...
                <div class="relative z-10">
                    <div class="flex items-center gap-3 mb-3">
                        <div
                            ...
                            <i class="fas fa-faucet text-red-600 text-2xl"></i>
                        </div>
                        <h2 class="text-2xl md:text-3xl font-extrabold text-red-800 tracking-tight">
                            Sanitary Application Details
                        </h2>
                    </div>
                    <p class="text-gray-700 text-sm md:text-base max-w-xl leading-relaxed">
                        Review all submitted information, attached documents, and progress for your sanitary permit
                        application.
                    </p>
                </div>
                ...
                <div class="hidden md:block relative">
                    <img src="https://cdn-icons-png.flaticon.com/512/728/728093.png" alt="Sanitary Illustration"
                ...
                <div class="bg-white shadow-lg rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div
                        ...
                        <div class="w-full sm:w-1/2">
                            <h1 class="text-xl font-semibold text-gray-800">Sanitary Applications</h1>
                            <p class="text-sm text-gray-500">Manage your sanitary permit applications.</p>
                        </div>
                    ...
                    <div class="bg-gray-50 p-4 sm:p-6 overflow-x-auto">
                        <table class="min-w-full text-sm text-gray-700" id="example">
                            <thead
                                class="bg-gray-50 border-b border-gray-200 text-gray-700 text-xs uppercase tracking-wider">
                                <tr>
                                    ...
                                    <tr class="hover:bg-blue-50 transition-all duration-200">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <div class="flex justify-center gap-2">
                                                <a href="{{ route('applicant.sanitary.sanitary_application_view', $application->id) }}"
