...
@section('content')
    <div x-data="{ open: false }" class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="rounded-xl p-6 bg-gradient-to-r from-red-100 via-red-200 to-red-300 shadow-md mb-6">
            <h2 class="text-2xl font-bold text-red-700">📑 Zoning Applications</h2>
            <p class="text-gray-700 text-sm mt-1">
                Track, manage, and create your zoning applications in this section.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <!-- Resubmit -->
            <div class="bg-white rounded-xl shadow-md p-5 flex items-center gap-4">
                <div class="p-3 bg-gray-200 text-white rounded-lg">
                    <i class="fas fa-redo text-2xl"></i>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Resubmit</p>
                    <h3 class="text-xl font-bold text-gray-800">{{ $applications->where('status', 'resubmit')->count() }}
                    </h3>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() {
            let table = $('#example').DataTable({
                ...
                language: {
                    ...
                    emptyTable: "🚫 No zoning applications found. Start your first one today."
                }
            });
