...
<head>
    <meta charset="UTF-8">
    <title>Onsite Visitation - Applicant Absent</title>
</head>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 20px;">
    ...
    <div
        ...
        <!-- Header -->
        <h2 style="color: #e67e22; margin-bottom: 10px;">Onsite Visitation - Applicant Absent</h2>
        ...
        <p style="font-size: 15px; color: #555;">
            Our records indicate that you were <strong>absent</strong> during your scheduled onsite visitation. Below
            are the details:
        </p>
        ...
        <table style="width: 100%; margin: 20px 0; border-collapse: collapse; font-size: 15px; color: #333;">
            ...
            <tr>
                <td style="padding: 8px 0;"><strong>Scheduled Visit Date:</strong></td>
                <td>{{ \Carbon\Carbon::parse($visitation->visit_date)->format('F j, Y') }}</td>
            </tr>
            <tr>
                <td style="padding: 8px 0;"><strong>Scheduled Visit Time:</strong></td>
                <td>{{ \Carbon\Carbon::parse($visitation->visit_time)->format('g:i A') }}</td>
            </tr>
            <tr>
                <td style="padding: 8px 0;"><strong>Status:</strong></td>
                <td style="text-transform: capitalize;">Absent</td>
            </tr>
        </table>

        <!-- Instructions -->
        <p style="margin-top: 20px; font-size: 15px; color: #555;">
            Please contact our office to request a re-schedule. Repeated absences may affect your application process.
        </p>
