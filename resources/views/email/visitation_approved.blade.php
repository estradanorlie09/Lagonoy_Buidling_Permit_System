...
<head>
    <meta charset="UTF-8">
    <title>Onsite Visitation Completed</title>
</head>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 20px;">
    ...
    <div
        ...
        <!-- Header -->
        <h2 style="color: #27ae60; margin-bottom: 10px;">Onsite Visitation Completed</h2>
        ...
        <p style="font-size: 15px; color: #555;">
            We are pleased to inform you that your onsite visitation has been successfully <strong>completed</strong>.
        ...
        <table style="width: 100%; margin: 20px 0; border-collapse: collapse; font-size: 15px; color: #333;">
            ...
            <tr>
                ...
                <td style="text-transform: capitalize;">Completed</td>
            </tr>
        </table>

        <!-- Instructions -->
        <p style="margin-top: 20px; font-size: 15px; color: #555;">
            Your application will now proceed to the next stage of processing. We will notify you if further action is
            required.
        </p>
