...
<head>
    <meta charset="UTF-8">
    <title>Zoning Application Disapproved</title>
</head>
...
<body style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px;">
    ...
    <div
        ...
        <p style="font-size: 16px; color: #555;">
            We regret to inform you that your zoning application has been <strong
                style="color: red;">disapproved</strong>.
        ...
        <table style="width: 100%; margin-top: 20px; font-size: 15px; color: #333; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="color: red; text-transform: capitalize;">{{ $application->status }}</td>
            </tr>
        ...
        <p style="margin-top: 30px; font-size: 15px; color: #555;">
            You may review the remarks and resubmit your application if applicable.
        </p>
